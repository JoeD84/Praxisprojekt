...
#define LCD_DATA0_PIN    3            /** 4 - 11 25 < pin for 4bit data bit 0  */
#define LCD_DATA1_PIN    2            /** 3 - 12 24 < pin for 4bit data bit 1  */
#define LCD_DATA2_PIN    1            /** 2 - 13 23 < pin for 4bit data bit 2  */
#define LCD_DATA3_PIN    0            /** 1 - 14 22 < pin for 4bit data bit 3  */
#define LCD_RS_PORT      PORTC		  /**           < port for RS line         */
#define LCD_RS_PIN       6            /** 7 -  6 28 < pin  for RS line         */
#define LCD_RW_PORT      PORTC        /**           < port for RW line         */
#define LCD_RW_PIN       5            /** 6 -  5 27 < pin  for RW line         */
#define LCD_E_PORT       PORTC        /**           < port for Enable line     */
#define LCD_E_PIN        4            /** 5 -  4 26 < pin  for Enable line     */
