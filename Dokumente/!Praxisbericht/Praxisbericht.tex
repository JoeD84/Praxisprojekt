...
\Fachbegriff{Fachbegriffe} werden blau hinterlegt.\\

\emph{Eigennamen} werden kursiv dargestellt.\\

\Code{Code-Fragmente} werden gelb hinterlegt.\\

\lstset{language=C, basicstyle=\footnotesize, showstringspaces=false, tabsize=8}
\lstinputlisting{Code/Hinweis.c}
...
% --------------------------------------------------------------------------
\include{Inhalt/Einleitung} 		% Motivation und Ziel
%\include{Inhalt/Kapitel_Begriffe}	% Begriffe
\include{Inhalt/Kapitel_Hardware}	% Hardware
\include{Inhalt/Kapitel_Software}	% Software
\include{Inhalt/Kapitel_AufbauderArbeit} % Aufbau
\include{Inhalt/Fazit}				% Fazit und Zukunft
